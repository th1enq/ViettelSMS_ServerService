...
type ServerServiceClient interface {
	...
	ImportServer(ctx context.Context, in *httpbody.HttpBody, opts ...grpc.CallOption) (*ImportServerResponse, error)
	ExportServer(ctx context.Context, in *ExportServerRequest, opts ...grpc.CallOption) (*httpbody.HttpBody, error)
}
...
func (c *serverServiceClient) ImportServer(ctx context.Context, in *httpbody.HttpBody, opts ...grpc.CallOption) (*ImportServerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ImportServerResponse)
	err := c.cc.Invoke(ctx, ServerService_ImportServer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serverServiceClient) ExportServer(ctx context.Context, in *ExportServerRequest, opts ...grpc.CallOption) (*httpbody.HttpBody, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(httpbody.HttpBody)
	err := c.cc.Invoke(ctx, ServerService_ExportServer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServerServiceServer interface {
	...
	ImportServer(context.Context, *httpbody.HttpBody) (*ImportServerResponse, error)
	ExportServer(context.Context, *ExportServerRequest) (*httpbody.HttpBody, error)
...
func (UnimplementedServerServiceServer) ImportServer(context.Context, *httpbody.HttpBody) (*ImportServerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ImportServer not implemented")
}
func (UnimplementedServerServiceServer) ExportServer(context.Context, *ExportServerRequest) (*httpbody.HttpBody, error) {
...
func _ServerService_ImportServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(httpbody.HttpBody)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServerServiceServer).ImportServer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServerService_ImportServer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServerServiceServer).ImportServer(ctx, req.(*httpbody.HttpBody))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ServerService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "server_service/v1/server_service.proto",
}
